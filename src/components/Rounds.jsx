...
const rounds = [
  {
    ...
    detail: 'Duration: 60 minutes • 30 Questions • No negative marking',
  },
  {
    num: '02',
    icon: Code2,
    ...
    detail: 'Duration: 90 minutes • 3–4 Problems',
  },
  {
    num: '03',
    icon: Bug,
    ...
    detail: 'Duration: 60 minutes • 2 Challenges • Pure debugging',
  },
];
